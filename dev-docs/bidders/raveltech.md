...
The encrypted uids can't be decrypted by the AppNexus server.
Therefore, the bid requests must go through RavelTech for the homomorphic matching process, hence the URL replacement in the bid requests.

**Every other characteristics of the AppNexus bid requests remain unchanged.**
**Disclaimer: the information below is a duplicate of the AppNexus documentation.**
The most recent version of the AppNexus documentation can be found at [https://github.com/prebid/prebid.github.io/blob/master/dev-docs/bidders/appnexus.md]
